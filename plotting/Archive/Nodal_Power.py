...
for idx, location in enumerate(locations):
    data_location = data_1[(data_1['capacity_type'] == 'power') &
                           (data_1['technology'].isin(technologies_to_keep)) &
    ...
    # Summing the columns and adding the result as a new column
    ...
    axes[idx].set_title(f'Stacked Bar Plot of Power Capacity by Technology in {location}')

# Add common y-axis label
axes[0].set_ylabel('Power (TW)')
...
plt.savefig(out_folder1 + "\\Combined_power_stacked_bar_plot.png", bbox_inches='tight')
